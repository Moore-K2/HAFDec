...
|-------------------|--------|---------------------|------------|---------|--------|-------|----------|--------------|---------------|---------------|
| [HAFDec(pretrain)](https://github.com/https://pan.baidu.com/s/119yF3WndSO6hoqXpFuMCZQ?pwd=w6hd)  |  2.5M  | yes                 | 640x192    | 0.107   | 0.774  | 4.580 | 0.183    | 0.886        | 0.962        | 0.983         |
| [HAFDec](通过网盘分享的文件：train from scratch(https://github.com/https://pan.baidu.com/s/18U0ECsqa4ZJ9V0sfaE0x0A?pwd=uctw)            | 2.5M   | no               | 640x192    | 0.122  | 0.926  | 4.846| 0.198   | 0.861       | 0.955        | 0.980        |
