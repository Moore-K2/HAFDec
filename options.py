...
class LiteMonoOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "eigen_test", "eigen_zhou_val"],
                                 default="eigen_test")
        # TODO: change model
        self.parser.add_argument('--cfg', type=str, default=str(ROOT / 'networks/models/lite_mono.yaml'), help='model.yaml path')
        self.parser.add_argument('--cfg_first', type=str, default=True, help='whether first ')
